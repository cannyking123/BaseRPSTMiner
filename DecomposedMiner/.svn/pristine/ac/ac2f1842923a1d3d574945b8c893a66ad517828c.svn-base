...
public class DecomposedMidiZeroDiscoveryConfiguration extends DecomposedAbstractMinerZeroDiscoveryConfiguration {

	public final static String NAME = "Midi 0.0";
