...
public class DialogMy2 extends JPanel {
	...
	public DialogMy2(final UIPluginContext context, final CausalActivityMatrix matrix,
			final ModifyCausalActivityMatrixParameters parameters) {
		double size[][] = { { TableLayoutConstants.FILL}, { 250, 25, 25, 25 ,25, 25,25} };
		...
		final NiceSlider gammerB = SlickerFactory.instance().createNiceIntegerSlider("BOND", 2, 100, 2, Orientation.HORIZONTAL);
		
		
		gammerB.addChangeListener(new ChangeListener() {

			public void stateChanged(ChangeEvent e) {
				parameters.setB(gammerB.getSlider().getValue());
//				panel.removeAll();
//				updateViewMatrix(viewMatrix, matrix, parameters);
//				panel.add(visualizer.runUI(context, viewMatrix), "0, 0");
//				revalidate();
//				repaint();
		...
		final NiceSlider gammerP = SlickerFactory.instance().createNiceIntegerSlider("POLYGON", 2, 100, 2, Orientation.HORIZONTAL);
		
		
		gammerP.addChangeListener(new ChangeListener() {

			public void stateChanged(ChangeEvent e) {
				parameters.setP(gammerP.getSlider().getValue());
//				panel.removeAll();
//				updateViewMatrix(viewMatrix, matrix, parameters);
//				panel.add(visualizer.runUI(context, viewMatrix), "0, 0");
//				revalidate();
